...
let posse_names = ["NAOKI","KASHIKEN","SACCHAN","REIREI","KENTHI","TSUYOCHAN","KAZUNORI","KAZUKI"]
...
let content = `<h1 class="member_name">${posse_names[result["id"] - 9]}</h1>
<section class="section_member">
<img src="../img/${result["id"]}.jpg" alt="" class="member_img">
<div class="member_content">
        <p class="message_top">${posse_description[result["id"] - 9]}</p>
